...
(function(){
  ...
  function loadJobs(){
    return loadScript('js/jobs-prototype.js?v=6170');
  }

  function loadRecruiters(){
    return loadScript('js/recruiters.js?v=6187');
  }

  function loadEmployers(){
    return loadScript('js/employers.js?v=6182');
  }
  ...
  function loadPreview(){
    return loadScript('js/product-experience.js?v=453');
  }
