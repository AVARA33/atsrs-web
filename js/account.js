...
(function(){
  ...
  function setBuild(){qa('.build-badge').forEach(function(b){var d=b.querySelectorAll('div');if(d[0])d[0].textContent='ATSRS V336';if(d[1])d[1].textContent='Last Update: 25 Jul 2026';});}
...
(function(){
  'use strict';
  var BUILD='ATSRS V336';
  var UPDATE='Last Update: 25 Jul 2026';
