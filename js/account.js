/* ATSRS V179 split from V178 - account.js. Original JS execution order preserved by index script order. */

/* --- Original inline script id=ATSRS_V142_REFERENCES_ICON_EXPAND_JS --- */
(function(){
  'use strict';
...
/* --- Original inline script id=ATSRS_V144_REFERENCES_OVERLAY_MAXIMIZE_JS --- */
(function(){
  'use strict';
  var BUILD='ATSRS V178';
  var UPDATE='Last Update: 01 Jul 2026';
...
/* --- Original inline script id=ATSRS_V145_REFERENCES_FULL_WIDTH_STACK_JS --- */
(function(){
  'use strict';
  var BUILD='ATSRS V178';
  var UPDATE='Last Update: 01 Jul 2026';
...
/* --- Original inline script id=ATSRS_V146_REFERENCES_COMPACT_LIST_FIVE_FILES_SCROLL_JS --- */
(function(){
  'use strict';
  var BUILD='ATSRS V178';
  var UPDATE='Last Update: 01 Jul 2026';
...
/* --- Original inline script id=ATSRS_V147_BUILD_LABEL_SCRIPT --- */
(function(){
  function qa(s,r){return Array.from((r||document).querySelectorAll(s));}
