...
(function(){
  ...
  function setBuild(){qa('.build-badge').forEach(function(b){var d=b.querySelectorAll('div');if(d[0])d[0].textContent='ATSRS V351';if(d[1])d[1].textContent='Last Update: 26 Jul 2026';});}
