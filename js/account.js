...
(function(){
  ...
  function mainBox(f){
    var body=f?'<div class="atsrs-v156-main-row"><div class="atsrs-v156-main-name"><div class="atsrs-v156-main-identity"><span class="atsrs-v156-box-title">Main CV</span><b title="'+esc(f.name)+'">'+esc(f.name||'Main CV')+'</b></div><span>'+Math.round((f.size||0)/1024)+' KB</span></div><div class="atsrs-v156-actions"><button class="secondary" onclick="previewCV()">Preview</button><button class="secondary" onclick="downloadCV()">Download</button><button class="secondary" onclick="deleteCV()">Delete</button></div></div>':'<div class="atsrs-v156-empty">No Main CV uploaded yet.</div>';
