/* ATSRS V572 — read-only Jobs prototype. No mailbox or server writes. */
(function(){
  'use strict';
  var jobsView='cards';
  ...
  var JOBS=[
    ...
    {id:'maris-taiwan-supervisor',title:'ROV Supervisor',company:'Maris Subsea',location:'Taiwan',worksite:'Vessel',rov:'Seaeye Falcon',mobilisation:'1 Sep 2026',duration:'3–4 weeks, plus two travel days either side',received:'6 Aug 2026',summary:'Platform inspection scope covering GVI, CP and marine-growth cleaning.',requirements:'Seaeye Falcon or similar experience; OPITO Survival, CA-EBS, OEUK, passport, Seaman’s Book and Full GWO.',recruiterEmail:'ellie.malim@marissubsea.com',source:'Recruiter email'},
  ...
  function card(job){
    return '<article class="job-card" data-job-id="'+esc(job.id)+'">'+
      ...
      '<div class="job-details"><p class="job-requirements"><strong>Requirements</strong><span>'+esc(job.requirements)+'</span></p><div class="job-recruiter-info" aria-label="Recruiter information">'+recruiterFact('Recruiter organisation',job.company)+recruiterFact('Recruiter email',job.recruiterEmail)+recruiterFact('Listing source',job.source)+'</div><p class="job-fee-note"><strong>No candidate commission.</strong></p></div></article>';
  }
  function updateView(){
