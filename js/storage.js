/* ATSRS V179 split from V178 - storage.js. Original JS execution order preserved by index script order. */

/* --- Original inline script id=ATSRS_V148_BUILD_LABEL_SCRIPT --- */
(function(){
...
/* --- Original inline script id=ATSRS_V150_OLD_LOCK_REMOVED_COMPACT_ROWS_JS --- */
(function(){
...
/* --- Original inline script id=ATSRS_V151_INDEXEDDB_REFERENCES_UPLOAD_FIX_JS --- */
(function(){
  'use strict';
  var BUILD='ATSRS V178';
...
/* --- Original inline script id=ATSRS_V152_REFERENCES_PERSISTENCE_HARD_FIX_JS --- */
(function(){
  'use strict';
  var BUILD='ATSRS V178';
  var UPDATE='Last Update: 01 Jul 2026';
...
/* --- Original inline script id=ATSRS_V156_CV_SLOTS_UNDER_MAIN_STABLE_LAYOUT_JS --- */
(function(){
  'use strict';
...
/* --- Original inline script id=atsrs-v157-login-cleanup-script --- */
(function(){
  'use strict';
  var BUILD='ATSRS V178';
  var UPDATE='Last Update: 01 Jul 2026';
