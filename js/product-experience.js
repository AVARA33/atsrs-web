...
(function(){
  ...
  async function pdfLibrary(){
    ...
    var moduleUrl=new URL('vendor/pdfjs/pdf.min.mjs?v=333',document.baseURI).href;
    var library=await import(moduleUrl);
    library.GlobalWorkerOptions.workerSrc=new URL('vendor/pdfjs/pdf.worker.min.mjs?v=333',document.baseURI).href;
