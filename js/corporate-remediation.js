...
(function(){
  ...
  function syncAccount(){
    ...
    var profile=byId('profilePage');
    if(corporate&&profile&&!profile.classList.contains('hidden'))setText('pageTitle','Corporate Account');
  ...
  function syncAll(){syncSidebar();syncAccount();syncCredentials()}
