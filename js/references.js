/* ATSRS V179 split from V178 - references.js. Original JS execution order preserved by index script order. */

/* --- Original inline script id=ATSRS_V127_DASHBOARD_STABILITY_JS --- */
(function(){
...
/* --- Original inline script id=ATSRS_V134_REFERENCES_STABLE_SINGLE_SYSTEM_JS --- */
(function(){
  'use strict';
...
/* --- Original inline script id=ATSRS_V136_DASHBOARD_STABILITY_DC_CU_JS --- */
(function(){
  var BUILD='ATSRS V178';
  var UPDATE='Last Update: 01 Jul 2026';
  function q(s,r){return (r||document).querySelector(s)}
...
/* --- Original inline script id=ATSRS_V137_TOP_ACTIONS_SCROLL_FIX_JS --- */
(function(){
  var BUILD='ATSRS V178';
  var UPDATE='Last Update: 01 Jul 2026';
  function q(s,r){return (r||document).querySelector(s)}
...
/* --- Original inline script id=ATSRS_V138_CV_PREVIEW_DIRECT_JS --- */
(function(){
...
/* --- Original inline script id=ATSRS_V141_REFERENCES_CARD_MAXIMIZE_JS --- */
(function(){
  'use strict';
  var BUILD='ATSRS V178';
  var UPDATE='Last Update: 01 Jul 2026';
