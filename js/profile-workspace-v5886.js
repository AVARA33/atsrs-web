(function(){
  'use strict';
  var state={ready:false,activeTab:'personal',personalEditing:false,availabilityEditing:false,initialDraft:'',initialBirthDisplay:'',scroll:{}};
  ...
  function enterPersonal(focusId){
    ...
    var stagedPhone=byId('profileStagePhone')&&byId('profileStagePhone').textContent||'',stagedWhatsapp=byId('profileStageWhatsapp')&&byId('profileStageWhatsapp').textContent||'',nationality=byId('profileInlineNationality'),country=byId('profileCountry'),countryDisplay=byId('inlineCountryValue'),birthDisplay=byId('profileInlineBirthDateDisplay'),phoneDisplay=byId('inlineMobileValue'),whatsappDisplay=byId('profileInlineWhatsappDisplay');if(nationality)nationality.value=country&&country.value||'';if(countryDisplay)countryDisplay.textContent=byId('profileStageCountry')&&byId('profileStageCountry').textContent||country&&country.value||'';if(birthDisplay)birthDisplay.value=byId('profileStageBirthDate')&&byId('profileStageBirthDate').textContent||'';state.initialBirthDisplay=birthDisplay&&birthDisplay.value||'';if(phoneDisplay)phoneDisplay.textContent=stagedPhone;if(whatsappDisplay)whatsappDisplay.textContent=stagedWhatsapp;state.personalEditing=true;state.initialDraft=draft();
