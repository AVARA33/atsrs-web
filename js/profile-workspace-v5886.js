(function(){
  ...
  function buildPersonalEditor(editor,source){
    ...
    field(10,'profilePosition');var timezone=customSelect(11,cloneSelect(byId('profileTimezone'),'profileInlineTimezone','Timezone'),'profileInlineTimezoneValue');
