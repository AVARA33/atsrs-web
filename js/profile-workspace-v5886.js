(function(){
  ...
  function enterPersonal(focusId){
    ...
    var stagedPhone=byId('profileStagePhone')&&byId('profileStagePhone').textContent||'',stagedWhatsapp=byId('profileStageWhatsapp')&&byId('profileStageWhatsapp').textContent||'',nationality=byId('profileInlineNationality'),country=byId('profileCountry'),birthDisplay=byId('profileInlineBirthDateDisplay'),phoneDisplay=byId('inlineMobileValue'),whatsappDisplay=byId('profileInlineWhatsappDisplay');if(nationality)nationality.value=country&&country.value||'';if(birthDisplay)birthDisplay.value=byId('profileStageBirthDate')&&byId('profileStageBirthDate').textContent||'';if(phoneDisplay)phoneDisplay.textContent=stagedPhone;if(whatsappDisplay)whatsappDisplay.textContent=stagedWhatsapp;state.personalEditing=true;state.initialDraft=draft();
