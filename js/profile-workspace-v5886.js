(function(){
  ...
  function enterPersonal(focusId){
    ...
    var target=focusId?byId(focusId):null;if(target)setTimeout(function(){target.focus({preventScroll:true});window.scrollTo(savedX,savedY)},0);else setTimeout(function(){window.scrollTo(savedX,savedY)},0);
  }
