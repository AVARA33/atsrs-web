(function(){
  ...
  function enterPersonal(focusId){
    ...
    if(window.loadProfile)window.loadProfile();var nationality=byId('profileInlineNationality'),country=byId('profileCountry'),birthDisplay=byId('profileInlineBirthDateDisplay'),phoneDisplay=byId('profileInlinePhoneDisplay'),whatsappDisplay=byId('profileInlineWhatsappDisplay');if(nationality)nationality.value=country&&country.value||'';if(birthDisplay)birthDisplay.value=byId('profileStageBirthDate')&&byId('profileStageBirthDate').textContent||'';if(phoneDisplay)phoneDisplay.value=byId('profilePhone')&&byId('profilePhone').value||byId('profileStagePhone')&&byId('profileStagePhone').textContent||'';if(whatsappDisplay)whatsappDisplay.value=byId('profileWhatsapp')&&byId('profileWhatsapp').value||byId('profileStageWhatsapp')&&byId('profileStageWhatsapp').textContent||'';state.personalEditing=true;state.initialDraft=draft();
