...
assert.match(index, /src="js\/public-landing\.js\?v=511"/);
...
assert.match(index, /href="css\/brand-auth-v513\.css\?v=513"/);

console.log('V513 build marker consistency tests passed');
