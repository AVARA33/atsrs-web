...
assert.match(index, /href="css\/public-landing\.css\?v=454"/);
assert.match(index, /src="js\/public-landing\.js\?v=453"/);
...
console.log('V454 build marker consistency tests passed');
