...
assert.match(index, /href="css\/account\.css\?v=517"/);
...
assert.match(index, /href="css\/corporate-remediation\.css\?v=517"/);
assert.match(index, /href="css\/personal-workspace-surface\.css\?v=436"/);
assert.match(index, /href="css\/personal-dashboard-qa\.css\?v=517"/);
assert.match(index, /href="css\/recipient-links\.css\?v=517"/);
...
assert.match(index, /href="css\/theme\.css\?v=517"/);
assert.match(index, /src="js\/theme\.js\?v=517"/);

assert.match(index, /href="css\/brand-auth-v513\.css\?v=517"/);

console.log('V517 build marker consistency tests passed');
