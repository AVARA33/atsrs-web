...
assert.match(index, /src="js\/storage\.js\?v=505"/);
...
assert.match(index, /src="js\/public-landing\.js\?v=505"/);
...
console.log('V507 build marker consistency tests passed');
