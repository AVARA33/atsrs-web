...
assert.match(index, /href="vendor\/phosphor-icons\/phosphor-regular\.css\?v=440"/);
assert.match(index, /href="css\/shell-polish\.css\?v=440"/);
assert.match(index, /src="js\/shell-polish\.js\?v=440"/);
...
console.log('V440 build marker consistency tests passed');
