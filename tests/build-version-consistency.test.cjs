...
assert.match(index, /href="css\/public-landing\.css\?v=458"/);
assert.match(index, /src="js\/public-landing\.js\?v=456"/);
...
console.log('V458 build marker consistency tests passed');
