...
assert.match(index, /src="js\/storage\.js\?v=447"/);
...
assert.match(index, /src="js\/public-landing\.js\?v=451"/);
...
console.log('V452 build marker consistency tests passed');
