...
for (const asset of [
  ...
  assert.match(index, new RegExp(`src="js/${asset.replace('.', '\\.')}\\?v=389"`));
}
...
assert.match(runbook, /Frontend release: V389/);

console.log('V389 build marker consistency tests passed');
