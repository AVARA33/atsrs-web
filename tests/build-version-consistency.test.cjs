...
assert.match(index, /href="vendor\/phosphor-icons\/phosphor-regular\.css\?v=438"/);
assert.match(index, /href="css\/shell-polish\.css\?v=438"/);
assert.match(index, /src="js\/shell-polish\.js\?v=438"/);
...
console.log('V438 build marker consistency tests passed');
