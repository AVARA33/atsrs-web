...
assert.match(index, /src="js\/app\.js\?v=469"/);
...
assert.match(index, /href="css\/shell-polish\.css\?v=464"/);
...
console.log('V472 build marker consistency tests passed');
