...
(async () => {
  ...
  const shadowScript = index.indexOf('js/shadow-read.js?v=397');
  const adapterScript = index.indexOf('js/normalized-read-adapter.js?v=397');
  const configScript = index.indexOf('js/normalized-read-canary-config.js?v=397');
  const runtimeScript = index.indexOf('js/normalized-read-runtime.js?v=397');
  const storageScript = index.indexOf('js/storage.js?v=397');
  assert.ok(
