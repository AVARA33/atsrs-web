...
assert.match(index,/css\/shell-polish\.css\?v=482/,
...
assert.match(css,/#app\.app:not\(\.hidden\) select:focus-visible\{[\s\S]*?outline:0!important;[\s\S]*?border-color:#4e7187!important;[\s\S]*?rgba\(56,189,248,\.12\)/,
