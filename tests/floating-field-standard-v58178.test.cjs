...
assert.match(index, /data-atsrs-build="V5833"/);
assert.match(index, /floating-field-standard-v58178\.css\?v=58192/);
...
console.log('V5833 Jobs filter single-focus-ring contracts passed');
