...
const projectsCss = fs.readFileSync(path.join(root, 'css', 'projects.css'), 'utf8');
...
assert.match(html, /id="projectsWorkspaceCount"/);
assert.match(html, /data-project-view="cards"/);
assert.match(html, /data-project-view="list"/);
...
assert.match(projects, /atsrs_project_view/);
assert.match(projects, /aria-pressed/);
assert.match(projects, /role="table"/);
