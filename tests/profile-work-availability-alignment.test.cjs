...
assert.match(index, /floating-field-standard-v58178\.css\?v=58206/);
assert.match(css, /body\.personal-mode #profilePage \.work-availability-grid>\.atsrs-field-shell\{margin-top:0!important/);
...
console.log('V5849 Profile work-availability alignment contracts passed');
