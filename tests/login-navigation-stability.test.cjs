...
assert.ok(index.indexOf('js/storage.js?v=524') < index.indexOf('js/public-landing.js?v=536'));
assert.ok(index.indexOf('js/public-landing.js?v=536') < index.indexOf('js/ui.js?v=510'));
assert.ok(index.indexOf('js/public-landing.js?v=536') < index.indexOf('js/boot-refresh.js?v=443'));
