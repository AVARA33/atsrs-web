...
assert.match(index, /src="js\/public-landing\.js\?v=556"/);
assert.ok(index.indexOf('js/storage.js?v=524') < index.indexOf('js/public-landing.js?v=556'));
assert.ok(index.indexOf('js/public-landing.js?v=556') < index.indexOf('js/ui.js?v=510'));
assert.ok(index.indexOf('js/public-landing.js?v=556') < index.indexOf('js/boot-refresh.js?v=443'));
...
assert.match(theme, /#auth \.auth-home-link:hover\{[\s\S]*?text-decoration:none/);
assert.match(theme, /#auth \.auth-home-link:hover span\{[\s\S]*?text-decoration:underline/);
assert.match(theme, /#auth \.auth-home-link:focus-visible\{[\s\S]*?outline:0;[\s\S]*?text-decoration:none/);
assert.match(theme, /#auth \.auth-home-link:focus-visible span\{[\s\S]*?text-decoration:underline/);
