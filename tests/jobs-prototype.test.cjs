...
test('Jobs is isolated, navigable and visibly live',()=>{
  ...
  assert.match(index,/jobs-prototype\.css\?v=6136/);
  assert.match(index,/route-feature-loader\.js\?v=6136/);
  assert.doesNotMatch(index,/<script src="js\/jobs-prototype\.js\?v=58163"><\/script>/);
  assert.match(routeLoader,/loadScript\('js\/jobs-prototype\.js\?v=6136'\)/);
