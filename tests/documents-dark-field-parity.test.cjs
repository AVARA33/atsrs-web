...
assert.match(index, /data-atsrs-build="V5843"/);
assert.match(index, /floating-field-standard-v58178\.css\?v=58202/);
...
console.log('V5843 Personal and Corporate Documents Profile focus parity contracts passed');
