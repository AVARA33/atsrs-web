...
assert.match(index,/profile-production-parity-v5878\.css\?v=5880/);
...
assert.match(css,/#profilePage > \.panel \{[\s\S]*?max-width: 1440px !important;/);
assert.match(css,/html\[data-theme="dark"\][\s\S]*?#accountTitle \{[\s\S]*?color: #f4f6ef !important;/);
