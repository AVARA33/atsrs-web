...
assert.match(index, /css\/jobs-prototype\.css\?v=6107/);
...
assert.match(css, /\.jobs-secondary-primary\{[^}]+grid-template-columns:minmax\(0,330px\) repeat\(3,minmax\(0,1fr\)\) 100px/);
