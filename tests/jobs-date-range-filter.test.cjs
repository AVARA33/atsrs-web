...
assert.match(index, /css\/jobs-prototype\.css\?v=6106/);
...
assert.match(css, /\.jobs-secondary-primary\{[^}]+grid-template-columns:minmax\(0,330px\) repeat\(3,minmax\(0,1fr\)\) max-content/);
assert.match(css, /\.jobs-secondary-actions\{[^}]+grid-column:4\/6/);
