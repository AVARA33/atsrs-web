...
assert.match(html, /css\/sidebar-fixed-utilities-v550\.css\?v=553/);
...
assert.match(harness, /sidebar-fixed-utilities-v550\.css\?v=553/);
assert.match(harness, /id="navIntro"[\s\S]*?id="navPrivacy"/);

console.log('V553 fixed sidebar utility navigation contracts passed');
