...
assert.match(html,/js\/profile-sharing-v1\.js\?v=27/);
...
assert.match(css,/profile-sharing-link-request-actions button\{[^}]*min-width:72px!important;[^}]*height:24px!important/);
