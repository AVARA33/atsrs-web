...
assert.match(html,/css\/profile-sharing-v1\.css\?v=40/);
...
assert.match(html,/js\/profile-sharing-v1\.js\?v=32/);
...
assert.match(js,/action\('Approve'[\s\S]*?action\('Decline'[\s\S]*?action\('Edit'[\s\S]*?action\('Revoke'/,'Sharing row actions must remain ordered: request decisions first, then share management.');
