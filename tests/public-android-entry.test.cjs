...
assert.match(css, /@media\(max-width:1680px\) and \(min-width:721px\)[\s\S]*?\.public-nav\{display:none\}[\s\S]*?\.public-home-mobile,\.public-android-entry-mobile\{display:inline-flex\}/);
