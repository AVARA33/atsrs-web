...
assert.match(html,/<span role="button" tabindex="0" aria-label="Plans" data-resource="plans" data-label="Plans">/);
assert.match(html,/<span role="button" tabindex="0" aria-label="FAQ" data-resource="faq" data-label="FAQ">/);
assert.match(html,/<span role="button" tabindex="0" aria-label="Contact" data-resource="contact" data-label="Contact">/);
