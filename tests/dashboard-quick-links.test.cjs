...
assert.match(html,/href="\/\?route=resource&amp;resource=plans"/);
assert.match(html,/href="\/\?route=resource&amp;resource=faq"/);
assert.match(html,/href="\/\?route=resource&amp;resource=contact"/);
...
assert.match(css,/#navResource\{[\s\S]*display:none!important/);
