...
assert.match(index, /data-atsrs-build="V536"/);
assert.equal((index.match(/js\/public-landing\.js\?v=536/g) || []).length, 1);
assert.ok(index.indexOf('js/public-landing.js?v=536') < index.indexOf('js/boot-refresh.js?v=536'), 'public route must resolve before the boot fallback can reveal auth');
