...
assert.equal((index.match(/js\/public-landing\.js\?v=58147/g) || []).length, 1);
assert.ok(index.indexOf('js/public-landing.js?v=58147') < index.indexOf('js/boot-refresh.js?v=443'), 'public route must resolve before the boot fallback can reveal auth');
