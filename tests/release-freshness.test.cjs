...
assert.match(html, /data-atsrs-build="V6154"/);
assert.match(html, /ph ph-download-simple/);
assert.doesNotMatch(html, /atsrs-release-notice-label/);
assert.match(html, /src="js\/route-feature-loader\.js\?v=6154"/);
...
assert.match(html, /controls\.insertBefore\(updateNotice,controls\.querySelector\('\.atsrs-locale-control'\)/);
