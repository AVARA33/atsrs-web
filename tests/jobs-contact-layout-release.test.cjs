...
assert.match(index, /data-atsrs-build="V6111"/);
assert.match(index, /href="css\/jobs-prototype\.css\?v=6110"/);
assert.match(index, /src="js\/route-feature-loader\.js\?v=6110"/);
assert.match(loader, /loadScript\('js\/jobs-prototype\.js\?v=6110'\)/);
...
console.log('V6111 JobSearch card controls release is cache-busted');
