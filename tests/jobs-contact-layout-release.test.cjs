...
assert.match(index, /href="css\/jobs-prototype\.css\?v=6191"/);
assert.match(index, /src="js\/route-feature-loader\.js\?v=6191"/);
assert.match(loader, /loadScript\('js\/jobs-prototype\.js\?v=6191'\)/);
...
assert.doesNotMatch(jobs, /contact\(recruiterMeta,'Recruiter organisation'/);
