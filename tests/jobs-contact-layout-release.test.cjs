...
assert.match(index, /data-atsrs-build="V6108"/);
assert.match(index, /href="css\/jobs-prototype\.css\?v=6108"/);
assert.match(index, /src="js\/route-feature-loader\.js\?v=6108"/);
assert.match(loader, /loadScript\('js\/jobs-prototype\.js\?v=6108'\)/);
...
assert.match(jobs, /body\.append\(project\);a\.append\(head,details,body,c\)/);
...
console.log('V6108 JobSearch contact layout and readability release is cache-busted');
