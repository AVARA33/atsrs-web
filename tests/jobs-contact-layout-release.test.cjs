...
assert.match(index, /data-atsrs-build="V5922"/);
assert.match(index, /href="css\/jobs-prototype\.css\?v=5922"/);
...
assert.match(css, /animation:jobs-contact-hand-tap \.46s ease-out 1/);
assert.doesNotMatch(css, /animation:jobs-contact-hand-tap[^;}]*infinite/);
assert.match(css, /@media\(prefers-reduced-motion:reduce\)/);

console.log('V5922 JobSearch contact layout and readability release is cache-busted');
