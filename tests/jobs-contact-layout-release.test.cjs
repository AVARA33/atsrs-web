...
assert.match(index, /data-atsrs-build="V5917"/);
assert.match(index, /href="css\/jobs-prototype\.css\?v=5917"/);
...
console.log('V5917 JobSearch contact-layout release chain is cache-busted');
