...
test('V6172 cache-busts the profession-aware JobSearch card styles', () => {
  assert.match(index, /data-atsrs-build="V6172"/);
  assert.match(index, /css\/jobs-prototype\.css\?v=6172/);
