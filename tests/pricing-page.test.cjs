...
assert.match(index, /css\/pricing\.css\?v=6068/);
assert.match(pricing, /css\/pricing\.css\?v=6068/);
...
assert.match(pricing, /data-monthly="\$20" data-yearly="\$16"[\s\S]*?data-yearly-note="Save 20% · \$192 billed annually"/);
assert.match(pricing, /data-monthly="\$40" data-yearly="\$32"[\s\S]*?data-yearly-note="Save 20% · \$384 billed annually"/);
assert.match(pricing, /data-monthly="\$70" data-yearly="\$56"[\s\S]*?data-yearly-note="Save 20% · \$672 billed annually"/);
assert.match(pricing, /id="titan"[\s\S]*?data-monthly="\$120" data-yearly="\$96"[\s\S]*?data-yearly-note="Save 20% · \$1,152 billed annually"/);
...
assert.match(pricing, /js\/pricing\.js\?v=470/);
