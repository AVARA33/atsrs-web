...
assert.match(index, /id="sharedProfileSummaryFilter" data-atsrs-no-field-shell="true"/);
...
assert.match(css, /html\[data-theme="dark"\]\.atsrs-public-share-mode \.shared-profile-meta span[\s\S]*?background:#0b0d0c!important/);
...
assert.match(css, /\.atsrs-public-share-view \.atsrs-select-menu \.atsrs-select-option[\s\S]*?font-size:10px!important/);
