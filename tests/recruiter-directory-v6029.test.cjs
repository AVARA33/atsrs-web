...
assert.match(html,/css\/recruiter-directory-v6029\.css\?v=6035/);
...
assert.match(css,/#recruitersPage \.employer-actions a,[\s\S]*?flex:1 1 0;[\s\S]*?height:32px;[\s\S]*?font-size:9px;/);
...
assert.match(js,/companyCount \+ " companies"/);
