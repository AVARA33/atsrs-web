...
assert.match(js,/function moveSecurityContacts\(\)/);
...
assert.match(css,/\.profile-security-contact-dialog \{[\s\S]*?width:min\(420px,calc\(100vw - 24px\)\)/);
assert.match(html,/css\/profile-production-parity-v5878\.css\?v=5979/);
assert.match(html,/js\/profile-workspace-v5886\.js\?v=5957/);
...
assert.match(js,/moveSecurityContacts\(\)/);
