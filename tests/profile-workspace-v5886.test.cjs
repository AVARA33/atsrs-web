...
assert.match(html,/profile-security-heading[\s\S]*?ph-shield-check[\s\S]*?Manage your account security and access settings/);
...
assert.match(html,/css\/profile-production-parity-v5878\.css\?v=5982/);
assert.match(html,/js\/profile-workspace-v5886\.js\?v=5959/);
...
assert.match(css,/\.profile-security-verification-flow \{[\s\S]*?grid-template-columns:minmax\(255px,1\.15fr\)/);
