...
assert.match(css,/\.profile-security-contact-editor \{ grid-column:1\/-1; grid-row:2/);
assert.doesNotMatch(css,/\.profile-security-contact-editor \{ position:fixed/);
assert.match(html,/css\/profile-production-parity-v5878\.css\?v=5980/);
assert.match(html,/js\/profile-workspace-v5886\.js\?v=5958/);
