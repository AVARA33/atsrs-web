...
assert.match(html, /data-atsrs-build="V6079"/);
...
assert.match(html, /css\/documents-register-v5976\.css\?v=6017/);
...
assert.match(css, /scroll-padding-bottom:12px/);
assert.match(css, /\.atsrs-document-register\{[\s\S]*?margin-bottom:12px!important/);
