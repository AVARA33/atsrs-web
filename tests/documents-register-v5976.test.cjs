...
assert.match(html, /css\/documents-register-v5976\.css\?v=6018/);
...
assert.match(app, /window\.innerHeight-wrapTop-2/);
assert.doesNotMatch(app, /panelBottom/);
assert.match(app, /Math\.ceil\(next\)\+2>available/);
