...
assert.match(html,/css\/profile-privacy-v1\.css\?v=17/);
...
assert.match(html,/js\/profile-privacy-v1\.js\?v=10/);
assert.match(js,/visibilityValue\(savedMode\)===legacy\?savedMode:legacyMode/);
assert.match(js,/setTimeout\(function\(\)\{if\(!editing\)renderStoredProfile\(\)\},0\)/);
