...
assert.match(html,/css\/profile-privacy-v1\.css\?v=15/);
...
assert.match(js,/function syncFieldsForMode\(\)/);
assert.match(js,/draft\.fields\[key\]=draft\.mode/);
assert.match(js,/if\(draft\.mode==='custom'\)/);
assert.match(html,/js\/profile-privacy-v1\.js\?v=5/);
