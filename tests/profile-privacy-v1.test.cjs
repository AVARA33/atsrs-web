...
assert.match(html,/css\/profile-privacy-v1\.css\?v=23/);
...
assert.match(css,/profile-privacy-radio input\{[^}]*accent-color:#22c55e/);
...
assert.match(html,/js\/profile-privacy-v1\.js\?v=14/);
