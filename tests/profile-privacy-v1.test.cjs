...
assert.match(html,/css\/profile-privacy-v1\.css\?v=21/);
...
assert.match(css,/profile-privacy-radio input:checked\{[^}]*border-color:var\(--atsrs-field-accent/);
assert.match(css,/profilePrivacyRows\.is-locked \.profile-privacy-radio input:checked\{opacity:1\}/);
...
assert.match(html,/js\/profile-privacy-v1\.js\?v=13/);
