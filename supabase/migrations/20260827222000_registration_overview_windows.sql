-- Owner-only registration totals for the Dashboard.
begin;

create or replace function public.atsrs_get_registration_overview()
returns table (
  is_admin boolean,
...
begin
  ...
  if not v_is_admin then
    return query
      select false, null::bigint, null::bigint, null::bigint, null::bigint;
    return;
  end if;
