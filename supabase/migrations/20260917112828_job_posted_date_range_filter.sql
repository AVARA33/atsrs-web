-- Adds an inclusive posted-date interval without changing the existing feed contracts.
...
revoke all on function public.atsrs_jobs_feed_v3(integer,integer,text[],text,text,text,text,text,text,date,date,text[],boolean)
  from public, anon, authenticated, service_role;
grant execute on function public.atsrs_jobs_feed_v3(integer,integer,text[],text,text,text,text,text,text,date,date,text[],boolean)
