-- Extend the one-time verified-email Personal trial from seven days to one month.
-- Existing active trials receive the same one-month window from their original
-- start time; the claim ledger continues to prevent repeat trials.
...
update public.atsrs_subscriptions
 ...
 where status = 'trialing'
   ...
   and trial_ends_at < trial_started_at + interval '1 month';
